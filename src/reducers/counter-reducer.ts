...
export type ActionType = IncrementAT | ResetAT | SetEditModeAT | SetStartValueAT | SetMaxValueAT
...
export const resetValueAC = (value: number): ResetAT => ({type: RESET_VALUE, value})
